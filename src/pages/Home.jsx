  ...
  return (
    <div>
      <div className=" flex justify-center">
        <div
          className="
            bg-gray-100 flex  dark:bg-gray-800 pt-10 mt-32 rounded-xl shadow-lg shadow-indigo-500/50  "
        >
      ...
      <div className="py-20 flex  justify-center ">
        <div className="p-2  w-1/2 flex-col items-center justify-center pt-8 mt-8 border-t border-gray-200 ">
          <div className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 text-center">
            <h2>What i do</h2>
          </div>
          <div className="flex gap-4 ">
            <div
              className="w-1/3 p-5 text-black 
            bg-gray-100 dark:bg-gray-800 rounded-xl shadow-lg shadow-indigo-500/50"
            >
